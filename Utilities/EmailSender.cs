...
namespace Utilities
{
    public class EmailSender : IEmailSender
    {
        ...
        {
            // Because we're using app password, mail should be sent from me
            ...
            try
            {
                SmtpClient smtpClient = new SmtpClient
                {
                    ...
                    Credentials = new System.Net.NetworkCredential(_emailSettings.FromEmail, _emailSettings.FromPassword)
                };
